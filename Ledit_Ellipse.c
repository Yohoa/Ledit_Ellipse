...
#define PI		3.14159265358979323846 //一些参数
#define SIZE		1
...
#define NUM  56 //划分的份数
   ...
   //椭圆   1
  	void drawC_1( LCell Cell, LLayer Layer,  double offsetX, double offsetY )//画图函数
	{
		int i=0;
		int	cnt	= NUM;//划分的份数
	float x[NUM],y[NUM];
	...
	{
		LMacro_BindToHotKey( KEY_F1, "drawRowland", "drawRowland" ); //设置快捷键
	}
